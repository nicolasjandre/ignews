...
declare module "@prismicio/client" {
    ...
    namespace Content {
        export type { PostDocumentData, PostDocumentDataSlicesSlice, PostDocument, AllDocumentTypes, ArticleSliceDefaultPrimary, ArticleSliceDefault, ArticleSliceVariation, ArticleSlice };
    }
}
